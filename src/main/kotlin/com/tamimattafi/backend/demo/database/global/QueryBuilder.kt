package com.tamimattafi.backend.demo.database.global

import com.tamimattafi.backend.demo.database.global.QueryBuilder.Expressions.ALL
import com.tamimattafi.backend.demo.database.global.QueryBuilder.Expressions.AND
import com.tamimattafi.backend.demo.database.global.QueryBuilder.Expressions.DELETE
import com.tamimattafi.backend.demo.database.global.QueryBuilder.Expressions.FROM
import com.tamimattafi.backend.demo.database.global.QueryBuilder.Expressions.INNER_JOIN
import com.tamimattafi.backend.demo.database.global.QueryBuilder.Expressions.IS_NOT_NULL
import com.tamimattafi.backend.demo.database.global.QueryBuilder.Expressions.IS_NULL
import com.tamimattafi.backend.demo.database.global.QueryBuilder.Expressions.LIKE
import com.tamimattafi.backend.demo.database.global.QueryBuilder.Expressions.LIMIT
import com.tamimattafi.backend.demo.database.global.QueryBuilder.Expressions.OFFSET
import com.tamimattafi.backend.demo.database.global.QueryBuilder.Expressions.ON
import com.tamimattafi.backend.demo.database.global.QueryBuilder.Expressions.OR
import com.tamimattafi.backend.demo.database.global.QueryBuilder.Expressions.ORDER_BY
import com.tamimattafi.backend.demo.database.global.QueryBuilder.Expressions.SELECT
import com.tamimattafi.backend.demo.database.global.QueryBuilder.Expressions.WHERE
import com.tamimattafi.backend.demo.database.global.QueryBuilder.Operators.IN

open class QueryBuilder(private var rawQuery: String = "") {
