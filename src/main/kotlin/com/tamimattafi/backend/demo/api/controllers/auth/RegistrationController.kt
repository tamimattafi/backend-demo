...
import com.tamimattafi.backend.demo.api.controllers.auth.Responses.ERROR_EMAIL_EXISTS
import com.tamimattafi.backend.demo.api.controllers.auth.Responses.ERROR_EMPTY_EMAIL
import com.tamimattafi.backend.demo.api.controllers.auth.Responses.ERROR_EMPTY_PASSWORD
import com.tamimattafi.backend.demo.api.controllers.auth.Responses.ERROR_EMPTY_USERNAME
import com.tamimattafi.backend.demo.api.controllers.auth.Responses.ERROR_INVALID_EMAIL
import com.tamimattafi.backend.demo.api.controllers.auth.Responses.ERROR_INVALID_PASSWORD
import com.tamimattafi.backend.demo.api.controllers.auth.Responses.ERROR_INVALID_USERNAME
import com.tamimattafi.backend.demo.api.controllers.auth.Responses.ERROR_USERNAME_EXISTS
import com.tamimattafi.backend.demo.api.controllers.auth.Validator.isValidEmail
import com.tamimattafi.backend.demo.api.controllers.auth.Validator.isValidPassword
import com.tamimattafi.backend.demo.api.controllers.auth.Validator.isValidUsername
